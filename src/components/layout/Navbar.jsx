...
const Navbar = () => {
  ...
  const navItems = [
    ...
    { 
      ...
      dropdown: [
        ...
        { path: '/tools/tekstherschrijver', label: 'Tekstherschrijver', color: 'hover:bg-indigo-50 text-gray-700' },
      ]
    },
    { 
      id: 'voor-docenten', 
  ...
  const handleDownloadClick = () => { window.open('/downloads', '_self'); };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden lg:flex items-center space-x-6">
            ...
            <button onClick={handleDownloadClick} className="bg-primary-600 text-white px-4 py-2 rounded-lg hover:bg-primary-700 transition-colors text-sm font-semibold shadow-sm">
              Downloads
            </button>
          </div>
          ...
          {isOpen && (
            ...
            >
              {navItems.map((item, index) => (
               ...
               <button onClick={() => { handleDownloadClick(); setIsOpen(false); }} className="block mx-4 mt-4 bg-primary-600 text-white px-4 py-3 rounded-lg text-center font-semibold w-auto">
                Downloads
              </button>
            </motion.div>
          )}
