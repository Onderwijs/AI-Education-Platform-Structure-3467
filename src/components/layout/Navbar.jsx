...
const Navbar = () => {
  ...
  const navItems = [
    ...
    {
      id: 'tools',
      label: 'Interactieve docenttools',
      dropdown: [
        ...
        { path: '/tools/oudermailgenerator', label: 'Ouder-mailgenerator', color: 'hover:bg-indigo-50 text-gray-700' },
        { path: '/tools/sociogram', label: 'Interactief Sociogram', color: 'hover:bg-indigo-50 text-gray-700' },
        { path: '/tools/klassenplattegrond', label: 'Klassenplattegrond', color: 'hover:bg-indigo-50 text-gray-700' },
      ]
    },
    {
      id: 'voor-docenten',
