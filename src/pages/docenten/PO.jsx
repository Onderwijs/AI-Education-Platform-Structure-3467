...
// Updated Dutch examples
const dutchExamples=[
{
title: "Kinderen leren over AI door het zelf te ontdekken",
...
const examples=[
{title: "Rekenen met Patronen",description: "Leerlingen ontdekken hoe AI patronen herkent in getallen en vormen",result: "80% beter begrip van wiskundige patronen"},
{title: "Creatief Vertellen",description: "AI-tools als inspiratie voor eigen verhalen en karakters",result: "Meer motivatie en originelere verhalen"},
{title: "Dieren Classificeren",description: "Teachable Machine gebruiken om dieren te sorteren",result: "Verhoogde nieuwsgierigheid naar biologie"}
];
...
Speciaal ontwikkeld voor het Nederlandse basisonderwijs
</p>
</motion.div>
...
Nederlandse AI-tools zijn vaak beter afgestemd op ons onderwijssysteem,bevatten Nederlandse voorbeelden en zijn ontwikkeld met Nederlandse privacy-wetgeving in gedachten. Veel tools zijn ook gratis beschikbaar voor Nederlandse scholen.
</p>
</div>
</div>
</div>
...
Internationale AI-Tools
</h2>
<p className="text-xl text-gray-600">
Bewezen effectieve AI-tools van over de hele wereld
</p>
</motion.div>
...
Begeleid kinderen altijd bij het gebruik van AI-tools. Leg uit hoe AI werkt en bespreek wat ze zien. Gebruik AI als hulpmiddel,niet als vervanging voor eigen denken en creativiteit. Controleer altijd of content geschikt is voor de leeftijd.
</p>
</div>
</div>
</div>
...
<p className="text-xl text-gray-600">
Direct inzetbare AI-lessen voor jouw klas
</p>
</motion.div>
...
<p className="text-xl text-gray-600">
Hoe Nederlandse PO-docenten AI succesvol inzetten
</p>
</motion.div>
