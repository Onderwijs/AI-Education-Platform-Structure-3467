          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-blue-100 mb-8">
                Maak kennis met kunstmatige intelligentie op een speelse en veilige manier. 
                Perfect voor groep 1 t/m 8, met speciale aandacht voor Nederlandse tools en voorbeelden.
              </p>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="text-left">
                  ...
                  <p className="text-orange-700 text-sm">
                    Nederlandse AI-tools zijn vaak beter afgestemd op ons onderwijssysteem, 
                    bevatten Nederlandse voorbeelden en zijn ontwikkeld met Nederlandse 
                    privacy-wetgeving in gedachten. Veel tools zijn ook gratis beschikbaar 
                    voor Nederlandse scholen.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="text-left">
                  ...
                  <p className="text-yellow-700 text-sm">
                    Begeleid kinderen altijd bij het gebruik van AI-tools. Leg uit hoe AI werkt en 
                    bespreek wat ze zien. Gebruik AI als hulpmiddel, niet als vervanging voor eigen 
                    denken en creativiteit. Controleer altijd of content geschikt is voor de leeftijd.
                  </p>
                </div>
              </div>
            </div>
