      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-600">
            ...
            <p>
              Je kunt een verzoek indienen door een e-mail te sturen naar <a href="mailto:privacy@aiinonderwijs.nl" className="text-primary-600 hover:underline">privacy@aiinonderwijs.nl</a>.
            </p>
            ...
            <p>
              ...
              <a href="mailto:privacy@aiinonderwijs.nl" className="text-primary-600 hover:underline">privacy@aiinonderwijs.nl</a>
            </p>
          </div>
