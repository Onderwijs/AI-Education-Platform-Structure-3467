...
const benefits=[
{icon: FiDownload,title: "🆕 GLOEDNIEUWE AI Startersgids PDF V2.0",description: "Compleet vernieuwde gids met enhanced security en Nederlandse focus!"},
{icon: FiMail,title: "Wekelijkse Tips",description: "Praktische AI-tips direct in je inbox"},
...
{title: "ChatGPT Prompt Library",description: "100+ geteste prompts voor verschillende vakken",format: "PDF Database - Gestructureerd en Overzichtelijk"},
{title: "AI Ethics Lesplan",description: "Complete les over ethiek en AI voor alle niveaus",format: "Professionele PDF + Materialen"}
];
...
Je ontvangt nu de volledig vernieuwde AI Startersgids V2.0 als professionele PDF. Enhanced security,Nederlandse focus en GEGARANDEERD NIET het oude bestand!
</p>
</div>

<p className="text-gray-600 mb-6">
De nieuwe AI Startersgids V2.0 wordt nu gedownload met enhanced security features,rode en groene waarschuwingsboxen en Nederlandse voorbeelden.
</p>
...
Ontvang direct onze volledig vernieuwde AI-toolkit V2.0 als professionele PDF. Enhanced security,Nederlandse focus en impossible-to-confuse design!
</p>
</motion.div>
</div>
</section>
...
V2.0 features: Rode/groene waarschuwingsboxen,Nederlandse focus,enhanced security,dubbele unieke IDs - ONMOGELIJK te verwarren met het oude bestand!
</p>
</div>
