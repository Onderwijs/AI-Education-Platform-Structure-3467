...
export default function LeerPadTool() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900">
      ...
      {/* TOOL CONTENT */}
      <div className="max-w-[1600px] mx-auto grid grid-cols-1 lg:grid-cols-12 min-h-[calc(100vh-300px)]">

        {/* LINKERKOLOM */}
        <aside className="lg:col-span-3 border-r border-slate-200 bg-white p-8">
          {!isStarted ? (
            <button
