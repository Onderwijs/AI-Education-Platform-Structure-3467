  ...
  const generateLesson = (e) => {
    ...
    const lessonContent = {
      ...
      schedule: [
        ...
        { phase: "Kern / Instructie & Verwerking", time: `${coreDuration} min`, activity: "Korte instructie gevolgd door zelfstandige verwerking of groepwerk gericht op het leerdoel." },
          ...
          >
            <div className="mb-6 pb-4 border-b">
              ...
              <p className="text-[11px] text-gray-500 font-medium leading-tight">
                ...
                Ondersteunt lesvoorbereiding en bewuste didactische keuzes.
              </p>
            </div>
            ...
            <form onSubmit={generateLesson} className="space-y-5">
              <div>
                ...
                <div className="relative">
                  ...
                  <input 
                    type="text" name="subject" required placeholder="Bijv. Geschiedenis, Wiskunde, Biologie"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input 
                      type="text" name="level" required placeholder="Bijv. 3 HAVO"
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input 
                      type="number" name="duration" required min="10" max="180"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <textarea 
                    name="goal" required rows="3" placeholder="Wat moeten de leerlingen aan het einde van de les kennen of kunnen?"
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
                <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                  ...
                  <div className="p-6 space-y-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900 mb-2 flex items-center gap-2">
                        <SafeIcon icon={FiList} className="text-indigo-500" />
                        Lesverloop
                      </h4>
