...
const {FiBook,FiDownload,FiCalendar,FiFilter,FiStar,FiClock,FiUsers}=FiIcons;
  ...
  return ( 
    <motion.div initial={{opacity: 0}} animate={{opacity: 1}} exit={{opacity: 0}} className="min-h-screen" > 
      ...
      <section className="bg-gradient-to-br from-emerald-600 to-teal-600 text-white py-20"> 
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"> 
          <motion.div initial={{opacity: 0,y: 50}} animate={{opacity: 1,y: 0}} className="text-center" > 
            ...
            <p className="text-xl text-emerald-100 max-w-3xl mx-auto"> Kant-en-klare AI-lessen. Compleet met lesplan,materialen en docentenhandleiding. </p> 
          </motion.div> 
        </div> 
      </section> 
      ...
      <section className="py-20 bg-white"> 
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"> 
          <motion.div initial={{opacity: 0,y: 50}} whileInView={{opacity: 1,y: 0}} viewport={{once: true}} className="text-center mb-16" > 
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4"> Uitgelicht: Nieuwe Les </h2> 
            <p className="text-xl text-gray-600"> Vers uit het LesLab en direct te gebruiken </p> 
          </motion.div> 
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center"> 
            ...
            <motion.div initial={{opacity: 0,x: 50}} whileInView={{opacity: 1,x: 0}} viewport={{once: true}} > 
              <div className="flex items-center space-x-4 mb-4"> 
                <span className="bg-emerald-100 text-emerald-800 px-3 py-1 rounded-full text-sm font-medium"> {currentLesson.level} </span> 
                <span className="text-gray-500">{currentLesson.subject}</span> 
                <span className="text-gray-500">•</span> 
                <span className="text-gray-500">{currentLesson.duration}</span> 
              </div> 
              <h3 className="text-3xl font-bold text-gray-900 mb-4"> {currentLesson.title} </h3> 
      ...
      <section className="py-20 bg-gray-50"> 
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"> 
          <motion.div initial={{opacity: 0,y: 50}} whileInView={{opacity: 1,y: 0}} viewport={{once: true}} className="text-center mb-16" > 
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4"> Lesarchief </h2> 
            <p className="text-xl text-gray-600"> Alle voorgaande lessen uit het LesLab </p> 
          </motion.div> 
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-12 justify-center"> 
            <div className="flex items-center space-x-2"> 
              ...
              <select value={selectedMonth} onChange={(e)=> setSelectedMonth(e.target.value)} className="border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-emerald-500 focus:border-transparent" > 
                {months.map(month=> ( 
            ...
            <div className="flex items-center space-x-2"> 
              ...
              <select value={selectedLevel} onChange={(e)=> setSelectedLevel(e.target.value)} className="border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-emerald-500 focus:border-transparent" > 
                {levels.map(level=> ( 
              ...
              > 
                ...
                <div className="p-6"> 
                  ...
                  <div className="flex items-center justify-between"> 
                    <span className="text-sm text-gray-500"> {lesson.downloads} downloads </span> 
                    <button 
      ...
      <section className="py-20 bg-emerald-600"> 
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center"> 
          <motion.div initial={{opacity: 0,y: 50}} whileInView={{opacity: 1,y: 0}} viewport={{once: true}} > 
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4"> Mis nooit meer een nieuwe les </h2> 
            <p className="text-xl text-emerald-100 mb-8"> Schrijf je in voor onze nieuwsbrief. </p> 
            <div className="flex flex-col sm:flex-row gap-4 justify-center"> 
              <input type="email" placeholder="Jouw email adres" className="px-6 py-3 rounded-lg border-0 focus:ring-2 focus:ring-emerald-300 flex-1 max-w-md" /> 
              <button className="bg-white text-emerald-600 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors flex items-center justify-center space-x-2"> 
