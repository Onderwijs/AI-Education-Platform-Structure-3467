        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              LesLab: Maandelijkse AI-Lessen
            </h1>
            <p className="text-xl text-emerald-100 max-w-3xl mx-auto">
              Elke maand een nieuwe, kant-en-klare AI-les. Compleet met lesplan, 
              materialen en docentenhandleiding.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <button className="bg-emerald-600 text-white px-8 py-4 rounded-lg font-semibold hover:bg-emerald-700 transition-colors flex items-center space-x-2">
                <SafeIcon icon={FiDownload} />
                <span>Download Complete Les</span>
              </button>
            </motion.div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-emerald-100 mb-8">
              Schrijf je in voor onze nieuwsbrief en ontvang elke maand de nieuwste les
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <input
                type="email"
                placeholder="Jouw email adres"
                className="px-6 py-3 rounded-lg border-0 focus:ring-2 focus:ring-emerald-300 flex-1 max-w-md"
              />
