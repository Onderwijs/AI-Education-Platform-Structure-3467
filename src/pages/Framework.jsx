    ...
    <div className="min-h-screen bg-gray-50"> 
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16"> 
        ...
        <div className="max-w-3xl mx-auto text-center mb-20"> 
          ...
          <p className="text-lg text-gray-600 leading-relaxed"> De snelle opkomst van generatieve AI stelt scholen voor complexe vragen. Zonder helder kader ontstaat er een wildgroei aan gebruik,of juist een verlammende onzekerheid. Het <strong>Onderwijs-AI Framework™</strong> dient als kompas voor docenten en schoolleiders om stapsgewijs en verantwoord te groeien in AI-geletterdheid. </p> 
        </div> 
        ...
        <section className="mb-24"> 
          ...
          <p className="text-gray-600 mb-12 max-w-2xl"> Dit model helpt scholen te bepalen waar ze nu staan en welke volgende stappen gezet kunnen worden voor een duurzame integratie. </p> 
              ...
              > 
                <div className="md:w-32 shrink-0"> 
                  ...
                  <h4 className="font-bold text-lg leading-tight">
                    {l.level === 'Level 4' ? <>Leerproces-<br />verrijking</> : l.title}
                  </h4> 
                </div> 
          ...
          <div className="relative z-10 max-w-3xl"> 
            ...
            <div className="space-y-6 text-slate-300"> 
              ...
              <ul className="grid grid-cols-1 md:grid-cols-2 gap-4"> 
                ...
                <li className="flex gap-3"> 
                  <SafeIcon icon={FiActivity} className="text-indigo-400 mt-1" /> <span><strong>Beleid:</strong> Welke afspraken maken we over privacy en toetsing?</span> </li> <li className="flex gap-3"> <SafeIcon icon={FiActivity} className="text-indigo-400 mt-1" /> <span><strong>Dialoog:</strong> Hoe betrekken we leerlingen bij deze ontwikkeling?</span> 
                </li> 
              </ul> 
            </div> 
          </div> 
