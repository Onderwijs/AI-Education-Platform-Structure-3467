...
const Framework = () => {
  ...
  const levels = [
    {
      level: "Niveau 0",
      title: "Oriëntatie & Bewustwording",
      desc: "Inzicht krijgen in wat AI is, wat het betekent voor onderwijs en waar kansen en grenzen liggen.",
      color: "bg-gray-100 text-gray-600"
    },
    {
      level: "Niveau 1",
      title: "Verkenning",
      desc: "Eerste veilige experimenten met AI-tools binnen de onderwijspraktijk.",
      color: "bg-blue-50 text-blue-700"
    },
    {
      level: "Niveau 2",
      title: "Didactische inzet",
      desc: "Gerichte toepassing van AI ter ondersteuning van lessen, leerdoelen en instructie.",
      color: "bg-indigo-50 text-indigo-700"
    },
    {
      level: "Niveau 3",
      title: "Leerproces-verrijking",
      desc: "Inzet van AI voor differentiatie, feedback, overzicht en verdieping van het leerproces.",
      color: "bg-purple-50 text-purple-700"
    },
    {
      level: "Niveau 4",
      title: "Borging & beleid",
      desc: "Structurele verankering van AI-gebruik binnen team, school en onderwijsvisie.",
      color: "bg-emerald-50 text-emerald-700"
    },
    {
      level: "Niveau 5",
      title: "Evaluatie & doorontwikkeling",
      desc: "Datagedreven reflectie, bijsturing en duurzame doorontwikkeling van AI-gebruik.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <section className="mb-24">
          ...
          <p className="text-gray-600 mb-12 max-w-2xl">
            Dit groeimodel beschrijft zes fasen van AI-adoptie in het onderwijs, van Niveau 0 (oriëntatie) tot en met Niveau 5 (evaluatie en doorontwikkeling). Het helpt scholen bepalen waar zij nu staan en welke volgende stappen logisch zijn voor een duurzame integratie.
          </p>
