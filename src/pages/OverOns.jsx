            ...
            {[
              {
                ...
                description: "Onderwijs.ai gelooft in concrete, toepasbare kennis in plaats van theoretische concepten."
              },
              {
                title: "Ethisch verantwoord",
                description: "Verantwoord gebruik van AI staat centraal."
              },
              {
                title: "Toegankelijk",
              ...
              },
              {
                ...
                description: "Onderwijs.ai bereidt docenten en leerlingen voor op een wereld waarin AI centraal staat."
              }
            ].map((value,index)=> (
              <motion.div 
                key={index}
