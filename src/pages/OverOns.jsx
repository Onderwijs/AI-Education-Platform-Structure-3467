        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-primary-100/90 mb-8 italic">
                Onderwijs.ai staat open voor samenwerkingen, pilots en licenties.
              </p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { title: "Praktijkgericht", description: "Onderwijs.ai gelooft in concrete, toepasbare kennis in plaats van theoretische concepten." },
              { title: "Ethisch verantwoord", description: "Verantwoord gebruik van AI staat centraal." },
              { title: "Toegankelijk", description: "AI moet beschikbaar zijn voor alle docenten, ongeacht technische achtergrond." },
              { title: "Toekomstgericht", description: "Onderwijs.ai bereidt docenten en leerlingen voor op een wereld waarin AI centraal staat." }
            ].map((value, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 50 }}
            ...
            >
              <div className="bg-white p-8 rounded-2xl shadow-lg">
                <p className="text-primary-600 font-semibold mb-6">
                  Interesse in samenwerking, een pilot of licentie? Stuur gerust een bericht.
                </p>
